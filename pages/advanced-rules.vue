<template>
  <layout-default>
    ...
    <section id="12">
      ...
      <v-alert type="info">
        Each player must sell all cards desired prior to purchasing cards. All cards must be purchased at once. A player may not purchase cards and then decide to purchase more after looking at the cards purchased.
      </v-alert>
      <v-alert type="info">
        Agent cards included in your Bureau Deck may be sold for their RES (Resource) number of <conspiracy-pool />, not their Cost number.
      </v-alert>
      <p class="text-center">
        12
      </p>
    ...
    <section id="40">
      ...
      <p>When each player has the opportunity to turn in <resource-pool /> Cost cards to create <conspiracy-pool />s, the player to the Investigating Player's left must do so first. After each player is finished, continue to the next player on the left until all players have had the opportunity to turn in cards.</p>
      <h3 class="text-decoration-underline">
    ...
    <section id="41">
      ...
      <p>In a multi-player game, cards must be paid for by the owning player. Players may not give <conspiracy-pool /> or <resource-pool /> to other players or combine funds to pay for a card.</p>
      <p>&nbsp;</p>
